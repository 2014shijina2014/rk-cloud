require(['jquery',rkjsPath+'rkTable.js',rkjsPath+'rkTags.js',rkjsPath+'rkWin.js',rkjsPath+'rkFormUtil.js',rkjsPath+'rkAlert.sweet.js',rkjsPath+'rkAjax.js'], 
	...
	var domainParamList=rkTable.init("domainParamList", "/userservice/rk/admin/core/domain/domainParam/queryPage",{},"radio","searchBtn");
	var btns=rkTags.btn.addEditDelBtn("tableDiv", true, function(){
		...
		rkWin.win("/views/sysManager/domain/domainParam/domainParam.detail.html",{method:"edit",id:ids[0],ajaxUrl:"/userservice/rk/admin/core/domain/domainParam/query"},"编辑站点参数",
		function(){
			rkTable.reload(domainParamList);
		});
	}, function(){
		var ids=rkTable.getChecked("domainParamList");
		rkAjax.postAjaxNoErr("/userservice/rk/admin/core/domain/domainParam/delete",{idArr:ids},function(data){
...
function renderDomain(data, type, row, meta){
	rkTableObj.tableRender.renderByUrl(row,meta,"/userservice/rk/admin/core/domain/domain/query",{id:data});
}