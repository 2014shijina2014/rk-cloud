require(['jquery','bootstrap',rkjsPath+'rkUtil.js',rkjsPath+'rkStore.js',rkjsPath+'rkTags.js',rkjsPath+'rkFormUtil.js',rkjsPath+'rkAlert.sweet.js',rkjsPath+'rkWin.js'], 
	...
	'use strict'
	rkFormUtil.initForm($("#mallPropertyForm"));
	//按钮
	var btns=rkTags.btn.saveCloseBtn("mallPropertyBtn", false, 
	function(){//保存
		rkFormUtil.submitForm("mallPropertyForm", "/rk/admin/cms/mall/property/save", function(data){
