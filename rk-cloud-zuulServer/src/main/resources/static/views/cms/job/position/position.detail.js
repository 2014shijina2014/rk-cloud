require(['jquery','bootstrap',rkjsPath+'rkUtil.js',rkjsPath+'rkStore.js',rkjsPath+'rkTags.js',rkjsPath+'rkFormUtil.js',rkjsPath+'rkAlert.sweet.js',rkjsPath+'rkWin.js'], 
	...
	'use strict'
	rkFormUtil.initForm($("#jobPositionForm"));
	//按钮
	var btns=rkTags.btn.saveCloseBtn("jobPositionBtn", false, 
	function(){//保存
		rkFormUtil.submitForm("jobPositionForm", "/rk/admin/cms/job/position/save", function(data){
