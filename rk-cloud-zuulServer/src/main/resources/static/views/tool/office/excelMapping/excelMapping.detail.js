require(['jquery','bootstrap',rkjsPath+'rkUtil.js',rkjsPath+'rkStore.js',rkjsPath+'rkTags.js',rkjsPath+'rkFormUtil.js',rkjsPath+'rkAlert.sweet.js',rkjsPath+'rkWin.js'], 
	...
	'use strict'
	rkFormUtil.initForm($("#excelMappingForm"));
	
	var btns=rkTags.btn.saveCloseBtn("excelMappingBtn", false, 
	function(){
		//保存
		rkFormUtil.submitForm("excelMappingForm", "/rk/admin/tool/office/excel/mapping/save", function(data){
