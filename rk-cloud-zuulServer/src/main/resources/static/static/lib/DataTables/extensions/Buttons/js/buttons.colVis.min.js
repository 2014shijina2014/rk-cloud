(function(g){"function"===typeof define&&define.amd?define(["jquery","dataTables","dataTablesBT"],function(d){return g(d,window,document)}):"object"===typeof exports?module.exports=function(d,e){d||(d=window);if(!e||!e.fn.dataTable)e=require("dataTables")(d,e).$;e.fn.dataTable.Buttons||require("dataTablesBT")(d,e);return g(e,d,d.document)}:g(jQuery,window,document)})(function(g,d,e,h){d=g.fn.dataTable;g.extend(d.ext.buttons,{colvis:function(a,b){return{extend:"collection",
